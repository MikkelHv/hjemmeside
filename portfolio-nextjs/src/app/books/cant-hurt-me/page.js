...
export const metadata = {
  title: "Can't Hurt Me - Book Review by Mikkel Hvedegaard",
  description: "My review and thoughts on David Goggins' book 'Can't Hurt Me'.",
};

export default function CantHurtMeBook() {
  return (
