...
export const metadata = {
  title: "Meditations - Book Review by Mikkel Hvedegaard",
  description: "My review and thoughts on Marcus Aurelius' book 'Meditations'.",
};

export default function MeditationsBook() {
  return (
    <div className="container mx-auto px-6 py-12 md:px-12 max-w-4xl">
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-12">
        ...
        <div className="w-full md:w-2/3">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Meditations of Marcus Aurelius</h1>
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-4">by Marcus Aurelius</p>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Reading in this book of meditations, thoughts of an original stoic, little by little it helps keep your ego in check.
          </p>
          <a 
